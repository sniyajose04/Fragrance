...
async function generateUniqueReferralCode() {
    ...
    if (referralExists) {
        return generateUniqueReferralCode(); // Recursively call the function until a unique code is found
    } else {
        return newReferralCode; // Return the unique referral code
    }
}
...
const insertUser = async (req, res) => {
    try {
        ...
        // Trim and convert referral code to uppercase
